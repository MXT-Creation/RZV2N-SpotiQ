...
* YOLOv3
******************************************/
/* Model Binary — installed by Yocto recipe to /hand_gesture_drp_ros/ */
const static std::string model_dir  = "/hand_gesture_drp_ros/hand_yolov3_onnx";
/* Pre-processing Runtime Object */
const static std::string pre_dir    = model_dir + "/preprocess";

/* Label list file */
const static std::string label_list = "/hand_gesture_drp_ros/labels.txt";
